...
export function createMarkup({ name, weather, main, sys, clouds }) {
  ...
  return `<div class="weather__card">
        ...
        <ul class="weather-info list">
            ...
            <li class="weather-info-item">
                <p class="feels-like-temp">Ощущается как: ${main.feels_like} <sup>&#176;</sup>С</p>
            </li>
            <li class="weather-info-item">
                <p class="sunrise-time">Восход солнца: ${sunrise}</p>
            </li>
            <li class="weather-info-item">
                <p class="sunset-time">Закат солнца: ${sunset}</p>
            </li>
            <li class="weather-info-item">
                <p class="clouds">Хмарность: ${clouds.all}%</p>
            </li>
